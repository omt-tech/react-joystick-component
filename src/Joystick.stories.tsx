...
joystickStories.add("Default joystick", () => (
  <Joystick
...
joystickStories.add("Default joystick with small stick", () => (
  <Joystick
    stickSize={10}
    start={action("Started")}
    move={action("Moved")}
...
joystickStories.add("Default joystick with 50% minDistance", () => (
  <Joystick
    minDistance={50}
    start={action("Started")}
    move={action("Moved")}
...
joystickStories.add("Control plane override", () => (
  <Joystick
    start={action("Started")}
...
joystickStories.add("Square joystick", () => (
  <div
    style={{ display: "flex", justifyContent: "space-around", padding: "25px" }}
  >
    <Joystick
      throttle={100}
      start={action("Started")}
...
joystickStories.add("50ms throttled joystick", () => (
  <Joystick
    start={action("Started")}
    throttle={50}
    move={action("Moved")}
...
joystickStories.add("Follow Cursor", () => (
...
joystickStories.add("HUGE joystick", () => (
  <Joystick
    start={action("Started")}
    move={action("Moved")}
    stop={action("Stopped")}
...
joystickStories.add("Tiny joystick", () => (
  <Joystick
    start={action("Started")}
    move={action("Moved")}
    stop={action("Stopped")}
...
joystickStories.add("Disabled joystick", () => (
  <Joystick
    start={action("Started")}
    move={action("Moved")}
    stop={action("Stopped")}
  ...
  return (
    <>
      <div className="tilt-manual-input">
        ...
        <h3>
          Thanks to{" "}
          <a href="https://github.com/mkosir/react-parallax-tilt">
            react-parallax-tilt
          </a>
        </h3>
      </div>
...
joystickStories.add("Default with direction text", () => (
  <DirectionComponent />
));

const Modal = ({ isOpen }: { isOpen: boolean }) => {
  if (!isOpen) return null;
  return ReactDOM.createPortal(<Joystick />, document.body);
};
